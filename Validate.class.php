...
use think\File; // Use In intanceof File
//use think\Request; //Use In 738 line
use think\Session; //Use In token
...
class Validate
{
    ...
    protected function method($value, $rule)
    {
        ...
        return strtoupper($rule) == REQUEST_METHOD;
    }
